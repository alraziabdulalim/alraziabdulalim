...
<head>
    ...
    <link rel="canonical" href="https://atlas.tailwindmade.com/post" />

    <meta property="og:url" content="https://atlas.tailwindmade.com/post" />
        ...
        <div>
            <div class="container mx-auto">
                ...
                <div class="pt-16 lg:pt-20">
                    <div class="border-grey-lighter border-b pb-8 sm:pb-12">
                        <span
                            class="bg-green-light font-body text-green mb-5 inline-block rounded-full px-2 py-1 text-sm sm:mb-8">category</span>
                        <h2
                            class="font-body text-primary block text-3xl font-semibold leading-tight dark:text-white sm:text-4xl md:text-5xl">
                    ...
                    <div class="prose prose border-grey-lighter dark:prose-dark max-w-none border-b py-8 sm:py-12">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Augue ut lectus arcu bibendum at varius vel pharetra vel.
                            Turpis nunc eget lorem dolor sed viverra ipsum nunc aliquet. Massa placerat duis ultricies
                            lacus sed turpis tincidunt. Cursus sit amet dictum sit amet justo donec enim. Nec dui nunc
                            mattis enim ut tellus elementum sagittis vitae. Id semper risus in hendrerit gravida rutrum
                            quisque. Posuere ac ut consequat semper viverra nam libero justo laoreet. Turpis cursus in
                            hac habitasse platea.</p>

                        <p>Elit ullamcorper dignissim cras tincidunt lobortis feugiat vivamus at augue. Pellentesque
                            massa placerat duis ultricies lacus sed. Interdum velit laoreet id donec ultrices tincidunt
                            arcu non. Id diam maecenas ultricies mi eget mauris. Urna id volutpat lacus laoreet non.
                            Amet est placerat in egestas erat imperdiet sed euismod. Dui sapien eget mi proin sed libero
                            enim sed faucibus. Facilisis mauris sit amet massa vitae. Vitae congue mauris rhoncus aenean
                            vel elit. Ut etiam sit amet nisl. Commodo odio aenean sed adipiscing diam donec adipiscing
                            tristique.</p>

                        <p>Non odio euismod lacinia at quis risus. Elit duis tristique sollicitudin nibh sit amet
                            commodo. Aliquam ultrices sagittis orci a scelerisque purus semper eget duis. Ipsum
                            consequat nisl vel pretium lectus. Pretium vulputate sapien nec sagittis aliquam. Morbi
                            tincidunt augue interdum velit euismod in pellentesque massa. Nullam non nisi est sit.</p>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Amet aliquam id diam maecenas ultricies mi eget mauris
                            pharetra. Congue nisi vitae suscipit tellus.</p>
                        ...
                        <div class="twitter-card">
                            <h4 class="twitter-card-title"> "When gone am I, the last of the Jedi will you be. The
                                Force runs strong in your family. Pass on what you have learned."</h4>
                        ...
                        <p>It’s great that I learned all that, because for my first real job in the industry, I was
                            going to use practically none of it. No Git, no Node, no Sass, no Grunt nor Gulp, no command
                            line, no Bootstrap. Just cold, hard WordPress. Nonetheless, this was going to present a and
                            things to learn.&lt;/p&gt;</p>

                        <h3 id="sed-do-eiusmod-tempor-incididunt">Sed do eiusmod tempor incididunt</h3>

                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Enim lobortis scelerisque fermentum dui faucibus in ornare
                            quam viverra. Augue ut lectus arcu bibendum at varius vel. Lacus viverra vitae congue eu
                            consequat ac felis.</p>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            ...
                            pellentesque habitant morbi. Semper feugiat nibh sed pulvinar.</p>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Laoreet non curabitur gravida arcu ac tortor dignissim
                            convallis aenean. Integer enim neque volutpat ac tincidunt vitae semper quis lectus.</p>

                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, <a href="/">sed do eiusmod
                                tempor incididunt ut</a> labore et dolore magna aliqua. Leo a diam sollicitudin tempor
                            id eu nisl nunc.</p>
...
<span class="nx">btn</span><span class="p">.</span><span class="nx">addEventListener</span><span class="p">(</span><span class="dl">'</span><span class="s1">click</span><span class="dl">'</span><span class="p">,</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span>
  ...
  <span class="p">}</span>
                    ...
                    <div class="flex items-center py-10">
                        ...
                        <a href="/">
                            <i
                                class="bx bxl-facebook text-primary hover:text-secondary dark:hover:text-secondary text-2xl transition-colors dark:text-white"></i></a>
                        <a href="/">
                            <i
                                class="bx bxl-twitter text-primary hover:text-secondary dark:hover:text-secondary pl-2 text-2xl transition-colors dark:text-white"></i>
                        </a>
                        <a href="/">
                            <i
                                class="bx bxl-linkedin text-primary hover:text-secondary dark:hover:text-secondary pl-2 text-2xl transition-colors dark:text-white"></i></a>
                        <a href="/">
                            <i
                                class="bx bxl-reddit text-primary hover:text-secondary dark:hover:text-secondary pl-2 text-2xl transition-colors dark:text-white"></i></a>
                    </div>
                </div>
            </div>
        </div>
