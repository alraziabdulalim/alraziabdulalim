        ...
        <div class="pt-8 lg:pt-12">
            @foreach ($experiences as $experience)
                <div class="border-grey-lighter border-b pb-8">
                    <a href="#"
                        class="font-body text-primary hover:text-green dark:hover:text-secondary block text-lg font-semibold transition-colors dark:text-white">{{ $experience['role'] }}</a>
                    <span
                        class="bg-green-light font-body text-green mb-4 inline-block rounded-full px-2 py-1 text-sm">{{ $experience['company'] }}</span>
